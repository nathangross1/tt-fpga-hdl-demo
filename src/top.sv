...
// For /fpga_pins/fpga|calc$aa.
logic [7:0] FpgaPins_Fpga_CALC_aa_a3;

// For /fpga_pins/fpga|calc$bb.
logic [7:0] FpgaPins_Fpga_CALC_bb_a3;

// For /fpga_pins/fpga|calc$cc.
logic [7:0] FpgaPins_Fpga_CALC_cc_a3;

// For /fpga_pins/fpga|calc$dd.
logic [7:0] FpgaPins_Fpga_CALC_dd_a3;
...
// For /fpga_pins/fpga|calc$dot.
logic [7:0] FpgaPins_Fpga_CALC_dot_a3;

// For /fpga_pins/fpga|calc$dummy.
logic FpgaPins_Fpga_CALC_dummy_a0;

// For /fpga_pins/fpga|calc$ee.
logic [7:0] FpgaPins_Fpga_CALC_ee_a3;
...
// For /fpga_pins/fpga|calc$ff.
logic [7:0] FpgaPins_Fpga_CALC_ff_a3;
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $valid.
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_valid_a1[0] <= FpgaPins_Fpga_CALC_valid_a0[0];
   ...
   if (1) begin : DEBUG_SIGS_GTKWAVE
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               (* keep *) logic [7:0] \///@3$aa ;
               assign \///@3$aa = FpgaPins_Fpga_CALC_aa_a3;
               (* keep *) logic [7:0] \///@3$bb ;
               assign \///@3$bb = FpgaPins_Fpga_CALC_bb_a3;
               (* keep *) logic [7:0] \///@3$cc ;
               assign \///@3$cc = FpgaPins_Fpga_CALC_cc_a3;
               (* keep *) logic [7:0] \///@3$dd ;
               assign \///@3$dd = FpgaPins_Fpga_CALC_dd_a3;
               ...
               (* keep *) logic [7:0] \///@3$dot ;
               assign \///@3$dot = FpgaPins_Fpga_CALC_dot_a3;
               (* keep *) logic  \///@0$dummy ;
               assign \///@0$dummy = FpgaPins_Fpga_CALC_dummy_a0;
               (* keep *) logic [7:0] \///@3$ee ;
               assign \///@3$ee = FpgaPins_Fpga_CALC_ee_a3;
               ...
               (* keep *) logic [7:0] \///@3$ff ;
               assign \///@3$ff = FpgaPins_Fpga_CALC_ff_a3;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 234 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 237 as: m5+board(/top, /fpga, 7, $, , calc)
            ...
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  //_@0
                     ...
                     assign FpgaPins_Fpga_CALC_valid_a0[0] =
                        FpgaPins_Fpga_CALC_reset_a0
                           ? 1'b0 :
                       (FpgaPins_Fpga_CALC_equals_in_a0 == 1) && (FpgaPins_Fpga_CALC_equals_in_a1 == 0)
                           ? 1'b1 :
                       1'b0;
                  ...
                  //_@1
                     ...
                     assign FpgaPins_Fpga_CALC_val1_a1[7:0] = FpgaPins_Fpga_CALC_reset_a1 ? 8'b0 : FpgaPins_Fpga_CALC_out_a3[7:0];
                  ...
                  //_@2
                     assign FpgaPins_Fpga_CALC_out_a2[7:0] =
                       ...
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'd3
                          ? FpgaPins_Fpga_CALC_quot_a2 :
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'd2
                          ? FpgaPins_Fpga_CALC_prod_a2 :
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'd1
                          ? FpgaPins_Fpga_CALC_diff_a2 :
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'd0
                          ? FpgaPins_Fpga_CALC_sum_a2 :
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'd4
                          ? FpgaPins_Fpga_CALC_mem_a4[7:0] :
                       //default
                       FpgaPins_Fpga_CALC_out_a3[7:0] ;
                  ...
                  //_@3
                     ...
                     assign FpgaPins_Fpga_CALC_zero_a3[7:0] = 8'b00111111;
                     assign FpgaPins_Fpga_CALC_one_a3[7:0] = 8'b00000110;
                     assign FpgaPins_Fpga_CALC_two_a3[7:0] = 8'b01011011;
                     assign FpgaPins_Fpga_CALC_three_a3[7:0] = 8'b01001111;
                     assign FpgaPins_Fpga_CALC_four_a3[7:0] = 8'b01100110;
                     assign FpgaPins_Fpga_CALC_five_a3[7:0] = 8'b01101101;
                     assign FpgaPins_Fpga_CALC_six_a3[7:0] = 8'b01111101;
                     assign FpgaPins_Fpga_CALC_seven_a3[7:0] = 8'b00000111;
                     assign FpgaPins_Fpga_CALC_eight_a3[7:0] = 8'b01111111;
                     assign FpgaPins_Fpga_CALC_nine_a3[7:0] = 8'b01101111;
                     assign FpgaPins_Fpga_CALC_aa_a3[7:0] = 8'b01110111;
                     assign FpgaPins_Fpga_CALC_bb_a3[7:0] = 8'b01111100;
                     assign FpgaPins_Fpga_CALC_cc_a3[7:0] = 8'b00111001;
                     assign FpgaPins_Fpga_CALC_dd_a3[7:0] = 8'b01011110;
                     assign FpgaPins_Fpga_CALC_ee_a3[7:0] = 8'b01111001;
                     assign FpgaPins_Fpga_CALC_ff_a3[7:0] = 8'b01110001;
                     assign FpgaPins_Fpga_CALC_dot_a3[7:0] = 8'b10000000;
            
                     assign uo_out[7:0] =
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0000
                           ? FpgaPins_Fpga_CALC_zero_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0001
                           ? FpgaPins_Fpga_CALC_one_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0010
                          ? FpgaPins_Fpga_CALC_two_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0011
                           ? FpgaPins_Fpga_CALC_three_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0100
                           ? FpgaPins_Fpga_CALC_four_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0101
                           ? FpgaPins_Fpga_CALC_five_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0110
                           ? FpgaPins_Fpga_CALC_six_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b0111
                           ? FpgaPins_Fpga_CALC_seven_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1000
                           ? FpgaPins_Fpga_CALC_eight_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1001
                           ? FpgaPins_Fpga_CALC_nine_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1010
                           ? FpgaPins_Fpga_CALC_aa_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1011
                           ? FpgaPins_Fpga_CALC_bb_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1100
                           ? FpgaPins_Fpga_CALC_cc_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1101
                           ? FpgaPins_Fpga_CALC_dd_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1110
                           ? FpgaPins_Fpga_CALC_ee_a3 :
                        FpgaPins_Fpga_CALC_digit_a3 == 4'b1111
                           ? FpgaPins_Fpga_CALC_ff_a3 :
                        //default
                             FpgaPins_Fpga_CALC_dot_a3;
               ...
               //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 4   // Instantiated from top.tlv, 174 as: m5+cal_viz(@2, /fpga)
                  // Only for Makerchip.
                  //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 9   // Instantiated from /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv, 6 as: m4+cal_viz_internal.
                     ...
                     //_|tb
                        ...
                        //_@2
                           assign {FpgaPins_Fpga_TB_mem_a2[7:0], FpgaPins_Fpga_TB_op_a2[2:0], FpgaPins_Fpga_TB_out_a2[7:0], FpgaPins_Fpga_TB_val1_a2[7:0], FpgaPins_Fpga_TB_val2_a2[7:0], FpgaPins_Fpga_TB_valid_a2[0]} = {FpgaPins_Fpga_CALC_mem_a2, FpgaPins_Fpga_CALC_op_a2, FpgaPins_Fpga_CALC_out_a2, FpgaPins_Fpga_CALC_val1_a2, FpgaPins_Fpga_CALC_val2_a2, FpgaPins_Fpga_CALC_valid_a2};
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 239 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
